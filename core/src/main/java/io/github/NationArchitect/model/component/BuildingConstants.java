...
public class BuildingConstants {
    ...
    static final double BASE_HAPPINESS_BOOST_AG = 0.02;
    ...
    static final double BASE_EDUCATION_PERFORMANCE_MULTIPLIER_AT = 0.002;
    static final double BASE_INDUSTRY_PERFORMANCE_MULTIPLIER_AT = 0.004;
    ...
    static final double BASE_PRODUCTION_WM = 500;
}
