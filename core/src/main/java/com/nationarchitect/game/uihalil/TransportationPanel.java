...
public class TransportationPanel extends UIPanel {
    ...
    public TransportationPanel(BaseScreen rootScreen) {
        super(rootScreen, "TRANSPORTATION");
        this.buildings = BuildingRegistry.getTransportationBuildings();
    }
    ...
    public void buildLayout() {
        ...
        Label title = makeLabel("TRANSPORTATION", 0xFFAA00FF, 2.0f, skin);
    ...
    private void onBuildClicked(Building building) {
        ...
        Gdx.app.log("TransportationPanel", "Building: " + building.getName() + " in " + currentRegion.getName());
    }
