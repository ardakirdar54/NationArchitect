...
public class InfrastructurePanel extends UIPanel {
    ...
    public InfrastructurePanel(BaseScreen rootScreen) { // DÜZELTİLDİ
        super(rootScreen, "INFRASTRUCTURE");
        this.buildings = BuildingRegistry.getInfrastructureBuildings();
    }
    ...
    public void buildLayout() {
        ...
        Label title = makeLabel("INFRASTRUCTURE", 0xBB88FFFF, 2.0f, skin);
    ...
    private TextureRegionDrawable makeDarkBg(float r, float g, float b, float a) {
        ...
        loadedTextures.add(tex); // Memory leak önlemek için listeye ekledim
