...
public class IndustryPanel extends UIPanel {
    ...
    public IndustryPanel(BaseScreen rootScreen) {
        super(rootScreen, "Industry");
        this.buildings = BuildingRegistry.getIndustryBuildings();
    }
    ...
    public void buildLayout() {
        ...
        Label title = makeLabel("INDUSTRY", 0x00E5FFFF, 2.0f, skin);
        ...
        pageLabel = makeLabel("1 / 6", 0xCCCCCCFF, 1.2f, skin);
    ...
    private Table buildCard(Building building, Skin skin) {
        ...
        addEffectRow(card, "Economy",    building.getEducationEffect(),   0xFFDD44FF, skin); // education slot = economy etkisi
    ...
    private void onBuildClicked(Building building) {
        if (currentRegion == null) {
            Gdx.app.log("IndustryPanel", "No region selected!");
            return;
        }
        Gdx.app.log("IndustryPanel", "Building: " + building.getName() + " in " + currentRegion.getName());
    }
