...
public class SecurityPanel extends UIPanel {
    ...
    public SecurityPanel(BaseScreen rootScreen) {
        super(rootScreen, "SECURITY");
        this.buildings = BuildingRegistry.getSecurityBuildings();
    }
    ...
    public void buildLayout() {
        ...
        Label title = makeLabel("SECURITY", 0xFF4444FF, 2.0f, skin);
    ...
    private void onBuildClicked(Building building) {
        ...
        Gdx.app.log("SecurityPanel", "Building: " + building.getName() + " in " + currentRegion.getName());
    }
