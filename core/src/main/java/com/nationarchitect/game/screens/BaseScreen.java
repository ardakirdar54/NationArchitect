...
import com.nationarchitect.game.ui.UIPanel;
import com.badlogic.gdx.Gdx;
import com.badlogic.gdx.graphics.GL20;

public abstract class BaseScreen implements Screen {
    protected static final float WIDTH  = 1920f;
    protected static final float HEIGHT = 1080f;

    protected Main game; //TO DO, Implement Game Manager
    ...
    public BaseScreen(Main game) {
        ...
        // this.skin = new Skin(Gdx.files.internal("ui/uiskin.json")); //TO DO, needs a skin file
    }
